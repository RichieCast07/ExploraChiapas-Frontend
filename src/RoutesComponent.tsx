...
export default function RoutesComponent() {
  return (
    <Routes>
      ...
      <Route
        path="/admin/negocios/solicitudes"
        element={<Navigate to="/admin/negocios" replace />}
      />
      ...
      <Route
        path="/admin/analitica/pro"
        element={
          <AdminRoute>
            <AdminIntelligenceProPage />
          </AdminRoute>
        }
      />
